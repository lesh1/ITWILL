/*
	...
	다차원배열(2차원 이상의 배열)
	 - 다차원 배열이란? 2차원이상의 배열을 의미 하며, 배욜 요소로 또 다른 배열을 가지는 배열을 의미
    ...
    2. 2차원 배열 메모리 생성
       ...
       -  행 크기만 지정하고 열크기는 동적으로 지정하는 방법으로 배열 메모리를 생성 할수 있음
          행 크기는 반드시 지정 해야합니다.
       - 문법
...
public class Test44 {
	public static void main(String[] args) {
	   ...
	   //int num[][] = new int[3][2];
		...
		//    단!  3개의 행 크기만 지정 하고 , 열크기는 지정하지 말자.
		//중요! 행크기는 반드시 지정 해야함.
		int[][] num1 = new int[3][];	
...
//배열 선언 및 2차원 배열 생성 연습하기 1.	
		...
		//charArry참조변수에 저장된 2차원 배열의 0인덱스 위치의 행에 대한 열의 갯수 얻어 출력
