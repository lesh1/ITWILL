...
/*
		...
		배열 메모리 공간의 특징
			...
			1. 같은 데이터형태의 값들만 배열메모리공간에 저장할수 있다.
			2. 기본 데이터형태의 값과  참조 데이터형태의 값 모두 저장 가능 하다.
		    3. 배열메모리에도 이름을 붙여서 배열메모리에 접근하여 데이터를 관리 할수 있다.
...
public class Test36 {
	public static void main(String[] args) {
		...
		//배열메모리의주소가저장된 변수명[인덱스위치번호] =  저장할 값;
		//3.배열 초기화
		score[0] = 50;
		score[1] = 100;
		score[3] = 90;
		...
		//배열 메모리의 각인덱스번호 위치에 저장되어 있는 값을 얻어 출력 하는 방법 :
		//배열메모리의 주소가 저장된 변수명[인덱스 위치번호]  ->  인덱스 위치번호에 있는 값을 얻어 낸다.
		//4-1. 배열 메모리에 저장된 값을 얻어 출력(배열 요소 출력)
		System.out.println("1번학생 : " +  score[0]);
		System.out.println("2번학생 : " +  score[1]);//1인덱스위치에 있는 100을 꺼내어 얻어 출력
		System.out.println("3번학생 : " +  score[2]);//2인덱스위치에 있는 80을 꺼내어 얻어 출력
		System.out.println("4번학생 : " +  score[3]);//3인덱스위치에 있는 90을 꺼내어 얻어 출력
		System.out.println("5번학생 : " +  score[4]);//4인덱스위치에 있는 30을 꺼내어 얻어 출력
