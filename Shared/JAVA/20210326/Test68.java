...
//생성자 오버로딩(다형성의 특징을 가지고 있다.)
//-하나의 생성자 이름으로 여러개의 생성자를 만들어 놓을수 있다.

//메소드 오버로딩(다형성의 특징을 가지고 있다.) 
//- 하나의 이름으로 다양한 형태의 메소드를 만들어 놓을수 있다.
...
public class Test68 {
	public static void main(String[] args) {
		...
		System1.out.println(2);//정수값을 전달 하면 출력후 한줄 뛰우기
		System1.out.println(1.2);//실수 값을 전달 하면 출력후 한줄 뛰우기
		System1.out.println("만든 문자열");//문자열을 전달 하면 출력후 한줄 뛰우기
